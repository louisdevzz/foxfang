...
const STATE_FILE_PATH = join(CONFIG_BASE_DIR, "foxfang", STATE_FILE_NAME);
      ...
      input: [
        {
          role: "system",
          content:
            "You classify GitHub issues and pull requests for FoxFang. Respond with JSON only, no extra text.",
        },
        {
          role: "user",
          content: [
...
async function main() {
  ...
  logHeader("FoxFang Issue Label Audit");
