...
show_usage() {
    cat << EOF
clawlog - FoxFang Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View FoxFang logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    FoxFang logs flow through the macOS unified log (subsystem: ai.foxfang).
