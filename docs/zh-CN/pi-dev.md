...
本指南总结了在 FoxFang 中开发 Pi 集成的合理工作流程。
...
状态存储在 FoxFang 状态目录下。默认为 `~/.foxfang`。如果设置了 `FOXFANG_STATE_DIR`，则使用该目录。
...
- https://docs.foxfang.ai/testing
- https://docs.foxfang.ai/start/getting-started
