---
read_when:
  - 你想在 FoxFang 中使用 NVIDIA 模型
  - 你需要设置 `NVIDIA_API_KEY`
summary: 在 FoxFang 中使用 NVIDIA 的 OpenAI 兼容 API
title: NVIDIA
x-i18n:
...
foxfang onboard --auth-choice skip
foxfang models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
