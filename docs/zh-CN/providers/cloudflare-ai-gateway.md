---
read_when:
  - 你想将 Cloudflare AI Gateway 与 FoxFang 一起使用
...
Cloudflare AI Gateway 位于提供商 API 前方，让你能够添加分析、缓存和控制功能。对于 Anthropic，FoxFang 会通过你的 Gateway 端点使用 Anthropic Messages API。
